...
namespace CrClient
{
    ...
    using CrClient.Packets.Definitions.Types.Client;
    using CrClient.Packets.Definitions.Types.Server;
    ...
    class Definition : Dictionary<ushort, System.Type>
    {
        ...
        public string Decode(Reader reader, ushort ID)
        {
            ...
            {
                return $"Missing definition for Packet {ID} [{PacketInfos.GetPacketName(ID)}]";
            }
        }
    }
}